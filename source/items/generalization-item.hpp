...
#include "content/generalization.hpp"

class GeneralizationItem : public ConnectionItem
{
	Q_OBJECT

public:
	GeneralizationItem(ItemScene* scene, const Identifier& id, quint64 level, const Generalization& generalization, const EndNode& beginNode, const EndNode& endNode, const QPolygonF& nodes, bool perpendicular);

	GeneralizationItem(ItemScene* scene, const Identifier& id, quint64 level, const QPointF& position);
